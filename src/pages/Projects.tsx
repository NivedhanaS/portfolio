...
const projects = [
  {
    ...
    description: "A full-stack MERN expense tracking application that enables users to manage daily spending, track income, and monitor savings goals in real time. Built with secure JWT authentication, RESTful APIs, and MongoDB, the app provides category-wise analytics, CSV export, and a responsive dark/light UI.",
    tech: ["React.js", "Node.js", "Express.js", "MongoDB"],
    code: "https://github.com/NivedhanaS/Daily_expense_log",
    demo: "https://daily-expense-log.vercel.app/",
...
const Projects = () => {
  return (
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-orbitron font-semibold mb-6">
            Projects
          </h1>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative bg-card border border-border rounded-2xl p-6 h-full backdrop-blur-sm hover:border-primary transition-all">
                ...
                <h3 className="text-2xl font-orbitron font-semibold mb-3 text-foreground">
                  {project.title}
                </h3>
  ...
  <a
    ...
    className="flex-1"
  >
    <Button size="sm" className="w-full font-rajdhani">
      ...
      Demo
        ...
        >
          <h2 className="text-3xl font-orbitron font-semibold mb-6">Internship Experience</h2>
